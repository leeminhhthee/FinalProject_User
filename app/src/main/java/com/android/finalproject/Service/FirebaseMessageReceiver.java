package com.android.finalproject.Service;
...
public class FirebaseMessageReceiver extends FirebaseMessagingService {
    ...
    private void showNotification(String title, String body) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(channelId, "LMT Shop", NotificationManager.IMPORTANCE_HIGH);
    ...
    public RemoteViews customView(String title, String body) {
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.notification);
        return remoteViews;
    }
}
