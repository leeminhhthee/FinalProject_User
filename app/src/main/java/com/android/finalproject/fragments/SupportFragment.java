    ...
    private void initControl() {
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:0974649644"));
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uriText = "mailto:" + Uri.encode("thelm.21it@vku.udn.vn") + "?subject=" +
                        Uri.encode("Feedback to LMT Shop !") + "&body=" + Uri.encode("");
        ...
        facebook.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                gotoUrl("https://www.facebook.com/lmtther.13");
            }
        ...
        instagram.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.instagram.com/lmtther.13/");
            }
            private void gotoUrl(String s) {
                Uri uri = Uri.parse(s);
                startActivity(new Intent(Intent.ACTION_VIEW,uri));
        ...
        youtube.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/channel/UCNHj5P5y48W7GcYK3L-2_DA");
            }
            private void gotoUrl(String s) {
                Uri uri = Uri.parse(s);
                startActivity(new Intent(Intent.ACTION_VIEW,uri));
