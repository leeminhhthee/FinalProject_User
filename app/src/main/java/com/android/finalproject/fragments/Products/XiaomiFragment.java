...
public class XiaomiFragment extends Fragment {
    private RecyclerView rc_xiaomi;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_products_xiaomi, container, false);
        rc_xiaomi = view.findViewById(R.id.rc_xiaomi);
        rc_xiaomi.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        list = new ArrayList<>();
        adapter = new SuggestProductAdapter(getContext(), list);

        db = FirebaseFirestore.getInstance();
        //New products home
        db.collection("AllProducts").whereEqualTo("pro_brand", "Xiaomi")
                .get()
